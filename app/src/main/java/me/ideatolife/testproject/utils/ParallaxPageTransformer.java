...
/**
 * Created by Jack Lebbos on 10/17/2016.
 */

public class ParallaxPageTransformer implements ViewPager.PageTransformer {

    /**
     *@link https://gist.github.com/Aracem/328d052603ec23391a3e#file-parallaxpagetransformer-java
     */
    ...
    public ParallaxPageTransformer add(int resource, float parallaxEnterEffect,
                     float parallaxExitEffect){
        mViewsToParallax.add(new ParallaxTransformInformation(resource,parallaxEnterEffect,parallaxExitEffect));
        return this;
    }
